...
use super::{
    ...
    GraphBLAS::{GrB_Descriptor, GrB_Index, GrB_Info, GrB_Matrix, GrB_Semiring, GrB_Type},
};
...
#[no_mangle]
#[allow(non_snake_case)]
unsafe extern "C" fn Delta_Matrix_M(
    c: *mut DeltaMatrix,
    transpose: bool,
) -> GrB_Matrix {
    (&*c).m(transpose).grb_matrix_ref()
}
...
unsafe extern "C" fn Delta_MatrixTupleIter_attach(
    ...
    (*iter).attach_range(&*a, 0, u64::MAX, false);
    GrB_Info::GrB_SUCCESS
}
...
unsafe extern "C" fn Delta_MatrixTupleIter_AttachRange(
    ...
    (*iter).attach_range(&*a, min_row, max_row, transpose);
    GrB_Info::GrB_SUCCESS
}
