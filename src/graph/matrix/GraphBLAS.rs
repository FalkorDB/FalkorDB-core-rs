...
// bindgen --allowlist-file deps/GraphBLAS/Include/GraphBLAS.h deps/GraphBLAS/Include/GraphBLAS.h --default-enum-style=rust -o deps/FalkorDB-rs/src/graph/matrix/GraphBLAS.rs
