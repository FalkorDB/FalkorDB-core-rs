 ...
 */
 ...
 use super::{
     delta_matrix_iter::DeltaMatrixIter, sparse_matrix::SparseMatrix, GraphBLAS::{
 ...
 mod tests {
     ...
     fn test_resize() {
         ...
         assert_eq!(t.nrows(), nrows);
         assert_eq!(t.matrix.nrows(), nrows);
         assert_eq!(t.delta_plus.nrows(), nrows);
         assert_eq!(t.delta_minus.nrows(), nrows);
         ...
         assert_eq!(t.matrix.ncols(), ncols);
         assert_eq!(t.delta_plus.ncols(), ncols);
         assert_eq!(t.delta_minus.ncols(), ncols);
